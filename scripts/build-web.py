...
"en": dict(
    ...
    desc="Learn Japanese daily: all 50 Minna no Nihongo lessons — 2,089 words with meanings in 17 languages, Hiragana & Katakana with audio, flashcards, stroke-order handwriting practice and scored challenges. Free on iPhone & iPad.",
    ...
    feat_sub="From your very first あ to all 2,089 words of the beginner course — a focused daily companion.",
    f1t="All 50 lessons",
    f1d="2,089 words across 50 lessons, in the order beginner courses teach them — roughly JLPT N5 to N4.",
    ...
    how2d="Pick a lesson, study its words with Flashcards, Train and Learn, then climb its challenge ladder.",
...
"zh": dict(
    ...
    desc="每天学日语：《大家的日本语》全 50 课 —— 2,089 个单词、17 种语言释义、平假名片假名发音、闪卡、按笔顺评分的书写练习与计分挑战关卡 —— iPhone 和 iPad 免费下载。",
    kicker="每天进步一点点",
    tagline="2,089 个单词、完整五十音图、闪卡、笔顺书写练习与计分挑战 —— 尽在一款精美的 iOS 应用。",
    hero_alt="Japanese Daily 每日日本語应用截图，展示今日单词卡片",
    free_note="iPhone 和 iPad 免费下载",
    feat_h2="所需的一切，{z}都在一个应用里",
    feat_sub="从第一个「あ」到 2,089 个单词全部掌握，每天陪你学习。",
    f1t="完整 50 课",
    f1d="2,089 个单词分成 50 课，按初级课程的教学顺序编排 —— 约合日语能力考 N5 到 N4。",
    f2t="17种语言的词汇释义",
    ...
    how2t="2. 一课一课往下学",
    how2d="选一课，用闪卡、练习和学习三种方式记住词汇，再去挑战关卡验收。",
    how3t="3. 养成每天学习的习惯",
...
"zh-Hant": dict(
    ...
    desc="每天學日語：《大家的日本語》全 50 課 —— 2,089 個單字、17 種語言釋義、平假名片假名發音、單字卡、依筆順評分的書寫練習與計分挑戰關卡 —— iPhone 與 iPad 免費下載。",
    kicker="每天進步一點點",
    tagline="2,089 個單字、完整五十音、單字卡、筆順書寫練習與計分挑戰 —— 全都在一款精美的 iOS App。",
    hero_alt="Japanese Daily 每日日本語 App 截圖，展示今日單字卡片",
    free_note="iPhone 與 iPad 免費下載",
    feat_h2="所需的一切，{z}都在一個 App",
    feat_sub="從第一個「あ」到 2,089 個單字全部掌握，每天陪你學習。",
    f1t="完整 50 課",
    f1d="2,089 個單字分成 50 課，依初級課程的教學順序編排 —— 約當日檢 N5 到 N4。",
    f2t="17種語言的單字釋義",
    ...
    how2t="2. 一課一課往下學",
    how2d="選一課，用單字卡、練習和學習三種方式記住單字，再去挑戰關卡驗收。",
    how3t="3. 養成每天學習的習慣",
...
"vi": dict(
    ...
    desc="Học tiếng Nhật mỗi ngày: trọn 50 bài Minna no Nihongo — 2.089 từ kèm nghĩa trong 17 ngôn ngữ, bảng Hiragana & Katakana có âm thanh, thẻ ghi nhớ, luyện viết được chấm theo thứ tự nét và các bậc thử thách có điểm — miễn phí trên iPhone & iPad.",
    ...
    feat_sub="Từ chữ あ đầu tiên đến trọn 2.089 từ của trình sơ cấp — người bạn đồng hành mỗi ngày.",
    f1t="Trọn 50 bài học",
    f1d="2.089 từ chia thành 50 bài, sắp xếp theo đúng thứ tự các khóa sơ cấp dạy — khoảng trình độ JLPT N5 đến N4.",
    ...
    how2d="Chọn một bài, ghi nhớ từ vựng bằng Thẻ ghi nhớ, Luyện tập và Học, rồi leo thang thử thách của bài đó.",
...
"de": dict(
    ...
    desc="Jeden Tag Japanisch lernen: alle 50 Lektionen von Minna no Nihongo — 2.089 Wörter mit Bedeutungen in 17 Sprachen, Hiragana & Katakana mit Audio, Karteikarten, Schreibübungen mit Strichfolge-Bewertung und bewertete Challenges. Kostenlos für iPhone & iPad.",
    ...
    feat_sub="Vom allerersten あ bis zu allen 2.089 Wörtern des Grundkurses — dein täglicher Begleiter.",
    f1t="Alle 50 Lektionen",
    f1d="2.089 Wörter in 50 Lektionen, in der Reihenfolge, in der Anfängerkurse sie vermitteln — etwa JLPT N5 bis N4.",
    ...
    how2d="Wähle eine Lektion, lerne ihren Wortschatz mit Karteikarten, Trainieren und Lernen und steige dann ihre Challenge-Leiter hinauf.",
...
"th": dict(
    ...
    desc="เรียนภาษาญี่ปุ่นทุกวัน: ครบ 50 บทของ Minna no Nihongo — 2,089 คำพร้อมความหมาย 17 ภาษา ตารางฮิรางานะ-คาตาคานะพร้อมเสียง บัตรคำ ฝึกเขียนที่ให้คะแนนตามลำดับขีดจริง และด่านท้าทายที่มีคะแนน — ฟรีบน iPhone และ iPad",
    ...
    feat_sub="จาก あ ตัวแรกจนครบทั้ง 2,089 คำ — เพื่อนคู่ใจที่อยู่กับคุณทุกวัน",
    f1t="ครบทั้ง 50 บท",
    f1d="2,089 คำใน 50 บท เรียงตามลำดับที่หลักสูตรระดับต้นสอน — ประมาณ JLPT N5 ถึง N4",
    ...
    how2d="เลือกบทเรียน จำคำศัพท์ด้วยบัตรคำ ฝึกฝน และเรียนรู้ แล้วไปพิสูจน์ตัวเองที่ด่านท้าทาย",
...
"my": dict(
    ...
    desc="နေ့တိုင်း ဂျပန်စာလေ့လာပါ — Minna no Nihongo သင်ခန်းစာ ၅၀ လုံး၊ ဘာသာစကား ၁၇ မျိုးဖြင့် အနက်ပါသော စကားလုံး ၂,၀၈၉ လုံး၊ အသံပါ ဟီရာဂနာ/ခတခနာဇယား၊ ကတ်ပြားများ၊ စာလုံးရေးအစဉ်အတိုင်း အမှတ်ပေးသည့် ရေးလေ့ကျင့်ခန်းနှင့် အမှတ်ပေး စိန်ခေါ်မှုအဆင့်များ — iPhone/iPad တွင် အခမဲ့။",
    ...
    how2d="သင်ခန်းစာတစ်ခုရွေးပြီး ကတ်ပြား၊ လေ့ကျင့်ရန်နှင့် လေ့လာရန်ဖြင့် ဝေါဟာရကို ရင်းနှီးပါ၊ ပြီးလျှင် စိန်ခေါ်မှုအဆင့်များကို တက်ပါ။",
...
"es": dict(
    ...
    desc="Aprende japonés cada día: las 50 lecciones de Minna no Nihongo — 2.089 palabras con significados en 17 idiomas, hiragana y katakana con audio, tarjetas, escritura puntuada por orden de trazos y retos con nota. Gratis en iPhone y iPad.",
    ...
    feat_sub="Desde tu primer あ hasta las 2.089 palabras del curso inicial — tu compañero de estudio diario.",
    f1t="Las 50 lecciones completas",
    f1d="2.089 palabras repartidas en 50 lecciones, en el orden en que las enseñan los cursos para principiantes — más o menos de JLPT N5 a N4.",
    ...
    how2d="Elige una lección, trabaja su vocabulario con Tarjetas, Entrenar y Aprender, y luego sube su escalera de retos.",
...
"fr": dict(
    ...
    desc="Apprenez le japonais chaque jour : les 50 leçons de Minna no Nihongo — 2 089 mots traduits en 17 langues, hiragana et katakana en audio, cartes mémo, écriture notée sur l'ordre des traits et défis notés. Gratuit sur iPhone et iPad.",
    ...
    feat_sub="De votre tout premier あ aux 2 089 mots du niveau débutant — votre compagnon d'étude quotidien.",
    f1t="Les 50 leçons au complet",
    f1d="2 089 mots répartis en 50 leçons, dans l'ordre où les cours pour débutants les enseignent — à peu près du niveau JLPT N5 à N4.",
    ...
    how2d="Choisissez une leçon, travaillez son vocabulaire avec les Cartes mémo, l'Entraînement et Apprendre, puis grimpez son échelle de défis.",
...
"ru": dict(
    ...
    desc="Учите японский каждый день: все 50 уроков Minna no Nihongo — 2089 слов с переводом на 17 языков, хирагана и катакана с озвучкой, карточки, прописи с оценкой по порядку черт и испытания с оценкой. Бесплатно на iPhone и iPad.",
    ...
    feat_sub="От самого первого あ до всех 2089 слов начального курса — ваш ежедневный спутник.",
    f1t="Все 50 уроков",
    f1d="2089 слов в 50 уроках — в том порядке, в котором их дают курсы для начинающих, примерно уровни JLPT N5–N4.",
    ...
    how2d="Выберите урок, разберите его лексику в Карточках, Тренировке и режиме Учить, а затем поднимайтесь по лестнице испытаний.",
...
"bn": dict(
    ...
    desc="প্রতিদিন জাপানি শিখুন: Minna no Nihongo-র সব ৫০টি পাঠ — ১৭টি ভাষায় অর্থসহ ২,০৮৯টি শব্দ, অডিওসহ হিরাগানা ও কাতাকানা, ফ্ল্যাশকার্ড, আসল স্ট্রোক অর্ডারে নম্বর দেওয়া হাতের লেখা অনুশীলন এবং নম্বরসহ চ্যালেঞ্জ — আইফোন ও আইপ্যাডে ফ্রি।",
    ...
    how2d="একটি পাঠ বেছে নিন, ফ্ল্যাশকার্ড, অনুশীলন ও শিখুন দিয়ে শব্দভাণ্ডার আয়ত্ত করুন, তারপর সেই পাঠের চ্যালেঞ্জের সিঁড়ি বেয়ে উঠুন।",
...
"hi": dict(
    ...
    desc="हर दिन जापानी सीखें: Minna no Nihongo के सभी 50 पाठ — 17 भाषाओं में अर्थ के साथ 2,089 शब्द, ऑडियो के साथ हिरागाना और कातकाना, फ़्लैशकार्ड, असली स्ट्रोक क्रम पर अंक देने वाला लेखन अभ्यास और अंकों वाली चुनौतियाँ — iPhone और iPad पर मुफ़्त।",
    ...
    feat_sub="पहले あ से लेकर शुरुआती कोर्स के पूरे 2,089 शब्दों तक — आपका रोज़ का साथी।",
    f1t="पूरे 50 पाठ",
    f1d="50 पाठों में 2,089 शब्द, उसी क्रम में जिस क्रम में शुरुआती कोर्स सिखाते हैं — लगभग JLPT N5 से N4 तक।",
    ...
    how2d="एक पाठ चुनें, फ़्लैशकार्ड, अभ्यास और सीखें से उसकी शब्दावली पक्की करें, फिर उसकी चुनौतियों की सीढ़ी चढ़ें।",
...
"ta": dict(
    ...
    desc="ஜப்பானியம் தினமும் கற்கவும்: Minna no Nihongo-வின் 50 பாடங்கள் — 17 மொழிகளில் பொருளுடன் 2,089 சொற்கள், ஒலியுடன் ஹிரகானா & கடகானா, ஃப்ளாஷ்கார்டுகள், உண்மையான கோட்டு வரிசைக்கு மதிப்பெண் தரும் கையெழுத்துப் பயிற்சி மற்றும் மதிப்பெண் சவால்கள் — iPhone & iPad-இல் இலவசம்.",
    ...
    feat_sub="முதல் あ முதல் தொடக்கநிலைப் பாடத்திட்டத்தின் 2,089 சொற்கள் வரை — உங்கள் தினசரி துணை.",
    f1t="50 பாடங்கள் முழுவதும்",
    f1d="50 பாடங்களில் 2,089 சொற்கள், தொடக்கநிலைப் பாடத்திட்டங்கள் கற்பிக்கும் அதே வரிசையில் — கிட்டத்தட்ட JLPT N5 முதல் N4 வரை.",
    ...
    how2d="ஒரு பாடத்தைத் தேர்ந்து ஃப்ளாஷ்கார்டுகள், பயிற்சி மற்றும் கற்று மூலம் சொற்களைப் பயிலுங்கள், பிறகு அதன் சவால் ஏணியில் ஏறுங்கள்.",
...
"te": dict(
    ...
    desc="ప్రతిరోజూ జపనీస్ నేర్చుకోండి: Minna no Nihongo 50 పాఠాలు — 17 భాషల్లో అర్థాలతో 2,089 పదాలు, ఆడియోతో హిరగానా & కటకానా, ఫ్లాష్‌కార్డ్‌లు, నిజమైన స్ట్రోక్ క్రమానికి మార్కులు ఇచ్చే రాత సాధన మరియు మార్కుల సవాళ్లు — iPhone & iPad‌లో ఉచితం.",
    ...
    feat_sub="మొదటి あ నుండి ప్రాథమిక కోర్సులోని మొత్తం 2,089 పదాల వరకు — మీ రోజువారీ సహచరుడు.",
    f1t="మొత్తం 50 పాఠాలు",
    f1d="50 పాఠాల్లో 2,089 పదాలు, ప్రాథమిక కోర్సులు నేర్పే క్రమంలోనే అమర్చబడ్డాయి — సుమారు JLPT N5 నుండి N4 వరకు.",
    ...
    how2d="ఒక పాఠాన్ని ఎంచుకుని ఫ్లాష్‌కార్డ్‌లు, సాధన మరియు నేర్చుకో మోడ్‌లతో పదజాలాన్ని నేర్చుకోండి, తర్వాత దాని సవాళ్ల నిచ్చెన ఎక్కండి.",
...
"fil": dict(
    ...
    desc="Matuto ng Japanese araw-araw: lahat ng 50 aralin ng Minna no Nihongo — 2,089 salita na may kahulugan sa 17 wika, hiragana at katakana na may audio, flashcards, pagsasanay sa pagsulat na may puntos ayon sa tunay na stroke order, at mga hamon na may puntos. Libre sa iPhone at iPad.",
    ...
    feat_sub="Mula sa iyong unang あ hanggang sa lahat ng 2,089 salita ng kursong pambeginner — ang iyong araw-araw na kasama.",
    f1t="Lahat ng 50 aralin",
    f1d="2,089 salita sa 50 aralin, nakahanay sa paraan ng pagtuturo ng mga kursong pambeginner — mga JLPT N5 hanggang N4.",
    ...
    how2d="Pumili ng aralin, pag-aralan ang bokabularyo nito gamit ang Flashcards, Magsanay at Matuto, pagkatapos ay akyatin ang hagdan ng mga hamon.",
...
"id": dict(
    ...
    desc="Belajar bahasa Jepang setiap hari: seluruh 50 pelajaran Minna no Nihongo — 2.089 kata dengan arti dalam 17 bahasa, hiragana & katakana beraudio, kartu kilas, latihan menulis yang dinilai menurut urutan goresan asli, dan tantangan bernilai. Gratis di iPhone & iPad.",
    ...
    feat_sub="Dari あ pertama Anda hingga seluruh 2.089 kata tingkat pemula — teman belajar harian Anda.",
    f1t="Seluruh 50 pelajaran",
    f1d="2.089 kata dalam 50 pelajaran, disusun sesuai urutan yang diajarkan kursus pemula — sekitar JLPT N5 hingga N4.",
    ...
    how2d="Pilih satu pelajaran, kuasai kosakatanya dengan Kartu kilas, Latihan, dan Belajar, lalu daki tangga tantangannya.",
...
"ko": dict(
    ...
    desc="매일 일본어를 배우세요: Minna no Nihongo 전체 50개 레슨 — 17개 언어 뜻이 달린 2,089개 단어, 음성이 담긴 히라가나·가타카나 표, 플래시카드, 실제 필순으로 채점하는 쓰기 연습, 점수가 매겨지는 챌린지까지. iPhone과 iPad에서 무료입니다.",
    kicker="매일 조금씩",
    tagline="2,089개 단어, 완전한 히라가나·가타카나 표, 플래시카드, 쓰기 연습, 점수가 매겨지는 챌린지 사다리까지 — 아름다운 iOS 앱 하나에 모두 담았습니다.",
    hero_alt="오늘의 단어 카드를 보여주는 Japanese Daily 앱 스크린샷",
    free_note="iPhone & iPad에서 무료",
    feat_h2="필요한 모든 것, {z} 앱 하나에",
    feat_sub="첫 あ부터 초급 과정의 2,089개 단어 전부까지 — 매일 함께하는 학습 동반자.",
    f1t="전체 50개 레슨",
    f1d="50개 레슨에 2,089개 단어, 초급 과정이 가르치는 순서 그대로 정리했습니다 — 대략 JLPT N5에서 N4 수준.",
    f2t="17개 언어로 된 어휘",
    ...
    how2d="레슨을 선택해 플래시카드, 훈련, 학습으로 어휘를 익히고, 그 레슨의 챌린지 사다리를 올라가세요.",
    how3t="3. 매일의 습관 만들기",
